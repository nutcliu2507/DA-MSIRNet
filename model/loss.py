...
class SSIMLoss(nn.Module):
    ...
    def __init__(self, window_size=11, size_average=True):
        ...
        self.channel = 1  # Default channel, will update dynamically
    ...
    def forward(self, img1, img2):
        ...
        ssim_val = ssim(img1, img2, self.window, self.window_size, channel, self.size_average)
        return 1 - ssim_val  # Loss is 1 - SSIM
